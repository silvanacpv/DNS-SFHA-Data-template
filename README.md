...
The main goal is to **identify patterns in crime data** and understand structural similarities and differences in criminal activity across these regions.
...
- **Preprocessing includes:**  
  ...
  - Filtering out offences representing a very small fraction of total incidents  
...
1. **Data Processing**  
   ...
   - Summarizing offences by type and by year  

2. **Analysis & Visualization**  
   - Scaling numeric features for comparability  
   - Applying dimensionality reduction (PCA) to visualize patterns  
   - Summarizing trends in offence types and yearly changes  

3. **Outputs**  
   - PCA plots highlighting differences between localities  
